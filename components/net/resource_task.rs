...
impl CancellationListener {
    pub fn new(receiver: Option<Receiver<CancelLoad>>) -> CancellationListener {
...
impl ResourceManager {
    ...
    fn load(&mut self,
        ...
        let cancel_receiver = id_sender.map(|sender| {
        ...
        let cancel_listener = CancellationListener::new(cancel_receiver);
