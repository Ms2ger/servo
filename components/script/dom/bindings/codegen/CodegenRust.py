...
class CGImports(CGWrapper):
    ...
    """
    def __init__(self, child, descriptors, imports, pub_imports=None):
        """
        ...
        if pub_imports:
            statements.extend('pub use %s;' % i for i in sorted(pub_imports))
...
class CGBindingRoot(CGThing):
    ...
    def __init__(self, config, prefix, webIDLFile):
        ...
        inherit_types = [
            'dom::bindings::codegen::InheritTypes::%s%s' % (d.name, suffix)
            for d in descriptors for suffix in ('Base', 'Derived', 'Cast')
        ]
