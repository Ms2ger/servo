...
use dom::bindings::DocumentBinding::DocumentReadyState;
use dom::bindings::DOMParserBinding;
use dom::bindings::DOMParserBinding::DOMParserMethods;
use dom::bindings::DOMParserBinding::SupportedType::{Text_html, Text_xml};
